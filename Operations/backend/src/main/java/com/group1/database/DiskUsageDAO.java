...
public interface DiskUsageDAO {
    ...
    @SqlUpdate("CREATE TABLE IF NOT EXISTS diskUsage(id int auto_increment primary key, hostName varchar(255), time timestamp, kbDiskAvailable double, kbDiskUsed double)")
    void createTable();
